...
@section('content')
    <div class="bg-white p-6 rounded shadow max-w-7xl mx-auto">
        <h2 class="text-lg font-semibold mb-4">Rekam Jejak Penempatan</h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full table-auto text-sm border rounded">
                <thead class="bg-gray-100 text-left">
                    <tr>
                        <th class="px-4 py-2">Nama Penempatan</th>
                        <th class="px-4 py-2">Jenis Penempatan</th>
                        <th class="px-4 py-2">Tujuan Penempatan</th>
                        <th class="px-4 py-2">Kota/Negara Tujuan</th>
        ...
        <div class="flex justify-between mt-6">
            <a href="/penugasan" class="px-4 py-2 rounded bg-white border text-blue-700 hover:bg-gray-100">← Sebelumnya</a>
    ...
    <div id="formModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-4xl">
            ...
            <form action="/penempatan/store" method="POST">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="text-sm">Nama Penempatan</label>
                        <input type="text" name="nama_penempatan" class="w-full border rounded px-3 py-2" required>
                    </div>
                    <div>
                        <label class="text-sm">Jenis Penempatan</label>
                        <input type="text" name="jenis_penempatan" class="w-full border rounded px-3 py-2" required>
                    </div>
                    <div>
                        <label class="text-sm">Tujuan Penempatan</label>
                        <input type="text" name="tujuan_penempatan" class="w-full border rounded px-3 py-2">
                    </div>
                    <div>
                        <label class="text-sm">Kota/Negara Tujuan</label>
                        <input type="text" name="kota_negara_tujuan" class="w-full border rounded px-3 py-2">
                    </div>
                    <div>
