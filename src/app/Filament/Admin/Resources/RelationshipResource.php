...
use App\Filament\Admin\Resources\RelationshipResource\Pages;
use App\Filament\Admin\Resources\RelationshipResource\RelationManagers;
...
class RelationshipResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Relationship';
    protected static ?string $navigationGroup = 'Public';
    protected static ?string $slug = 'public/relationship';
    public static ?string $label = 'Relationship';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('relationship')->searchable()->sortable(),
