            ...
            <table class="w-full table-auto text-sm border rounded">
                <thead class="bg-gray-100 text-left">
                    <tr>
                        ...
                        <th class="px-4 py-2">Bidang/Unit Organisasi</th>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-3xl">
            ...
            <form action="/jabatan/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="text-sm">Bidang / Unit Organisasi</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project coding\filament-imipas\filament-app\src\resources\views/occupation.blade.php ENDPATH**/ ?>